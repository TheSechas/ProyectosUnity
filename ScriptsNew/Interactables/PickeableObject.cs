...
public class PickableObject : MonoBehaviour, IInteractable
{
    ...
    [SerializeField] private string doorID;                 // ID para llaves.
    [SerializeField] private string objectName = "objeto";  // Texto UI (reservado).
    ...
    {
        // Empieza la inspección del objeto (recogible).
